...
CREATE TABLE `HeaderSaldoAwal` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `tgl_konversi` VARCHAR(191) NOT NULL,
...
UNIQUE INDEX `DetailSaldoAwal.akun_id_unique`(`akun_id`),
...
CREATE TABLE `Produk` (
    ...
    `beli_disabled` VARCHAR(191) NOT NULL,
    `jual_disabled` VARCHAR(191) NOT NULL,
...
CREATE TABLE `HeaderPenjualan` (
    ...
    `custom_invoice` VARCHAR(191) NOT NULL,
    ...
    `tgl_kontrak` VARCHAR(191) NOT NULL,
...
CREATE TABLE `DetailPenjualan` (
    ...
    `pajak_jual_id` INTEGER NOT NULL,
...
CREATE TABLE `DetailPembelian` (
    ...
    `pajak_id` INTEGER NOT NULL,
    `pajak_nama` VARCHAR(191) NOT NULL,
    `pajak_beli_id` INTEGER NOT NULL,
    `pajak_persen` INTEGER NOT NULL,
    `hasil_pajak` INTEGER NOT NULL,
    `jumlah` INTEGER NOT NULL,
...
CREATE TABLE `DetailBiaya` (
    ...
    `pajak_id` INTEGER NOT NULL,
    `pajak_nama` VARCHAR(191) NOT NULL,
    `pajak_akun_beli_id` INTEGER NOT NULL,
    `pajak_persen` INTEGER NOT NULL,
    `hasil_pajak` INTEGER NOT NULL,
    `jumlah` INTEGER NOT NULL,
    `jumlah2` INTEGER NOT NULL,
...
CREATE TABLE `TransferUang` (
    ...
    `tag` VARCHAR(191) NOT NULL,
    `status` VARCHAR(191) NOT NULL,
    `sisa_saldo_akuntransfer` INTEGER NOT NULL,
    `sisa_saldo_akunsetor` INTEGER NOT NULL,
...
CREATE TABLE `Aset` (
    ...
    `tag` VARCHAR(191) NOT NULL,
    `aset_non_depresiasi` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `PelepasanAset` (
    ...
    `header_aset_id` INTEGER NOT NULL,
...
CREATE TABLE `JurnalInvoicePelepasanAset` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `pelepasan_aset_id` INTEGER NOT NULL,
    `header_aset_id` INTEGER NOT NULL,
    `akun_id` INTEGER NOT NULL,
    `nominal` INTEGER NOT NULL,
    `tipe_saldo` VARCHAR(191) NOT NULL,
...
CREATE TABLE `SettingPerusahaan` (
    ...
    `tampilkan_logo` BOOLEAN NOT NULL,
    ...
    `email` VARCHAR(191) NOT NULL,
    `nama_bank` VARCHAR(191) NOT NULL,
    `cabang_bank` VARCHAR(191) NOT NULL,
    `alamat_bank` VARCHAR(191) NOT NULL,
    `nomor_rekening` VARCHAR(191) NOT NULL,
...
CREATE TABLE `HeaderReimburse` (
    ...
    `yang_mengetahui` VARCHAR(191) NOT NULL,
    `yang_menyetujui` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `DetailBankStatement` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `akun_id` INTEGER NOT NULL,
    `tgl_mutasi_bank` VARCHAR(191) NOT NULL,
    `deskripsi` VARCHAR(191) NOT NULL,
    `tgl_import` VARCHAR(191) NOT NULL,
    `debit` INTEGER NOT NULL,
    `kredit` INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE `JurnalBankStatement` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `detail_bank_statement_id` INTEGER NOT NULL,
    `akun_id` INTEGER NOT NULL,
    `deskripsi` VARCHAR(191) NOT NULL,
    `nominal` INTEGER NOT NULL,
    `tipe_saldo` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `DetailSaldoAwal` ADD FOREIGN KEY (`header_saldo_awal_id`) REFERENCES `HeaderSaldoAwal`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `DetailSaldoAwal` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `DetailPenjualan` ADD FOREIGN KEY (`pajak_jual_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `DetailPembelian` ADD FOREIGN KEY (`pajak_beli_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `JurnalBiaya` ADD FOREIGN KEY (`akun_biaya_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `DetailBiaya` ADD FOREIGN KEY (`pajak_akun_beli_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PengirimanBiaya` ADD FOREIGN KEY (`header_biaya_id`) REFERENCES `HeaderBiaya`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PengirimanBiaya` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalPengirimanBiaya` ADD FOREIGN KEY (`header_biaya_id`) REFERENCES `HeaderBiaya`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalPengirimanBiaya` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `JurnalTransferUang` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `HeaderTerimaUang` ADD FOREIGN KEY (`akun_setor_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `HeaderTerimaUang` ADD FOREIGN KEY (`kontak_id`) REFERENCES `Kontak`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `DetailTerimaUang` ADD FOREIGN KEY (`pajak_jual_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `JurnalTerimaUang` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `HeaderKirimUang` ADD FOREIGN KEY (`akun_bayar_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `HeaderKirimUang` ADD FOREIGN KEY (`kontak_id`) REFERENCES `Kontak`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `DetailKirimUang` ADD FOREIGN KEY (`pajak_beli_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `JurnalKirimUang` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `PelepasanAset` ADD FOREIGN KEY (`header_aset_id`) REFERENCES `Aset`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PelepasanAset` ADD FOREIGN KEY (`deposit_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalAset` ADD FOREIGN KEY (`header_aset_id`) REFERENCES `Aset`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalAset` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `JurnalPelepasanAset` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalPelepasanAset` ADD FOREIGN KEY (`header_aset_id`) REFERENCES `Aset`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalInvoicePelepasanAset` ADD FOREIGN KEY (`pelepasan_aset_id`) REFERENCES `PelepasanAset`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalInvoicePelepasanAset` ADD FOREIGN KEY (`header_aset_id`) REFERENCES `Aset`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalInvoicePelepasanAset` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `DetailReimburse` ADD FOREIGN KEY (`header_reimburse_id`) REFERENCES `HeaderReimburse`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `DetailBankStatement` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalBankStatement` ADD FOREIGN KEY (`detail_bank_statement_id`) REFERENCES `DetailBankStatement`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JurnalBankStatement` ADD FOREIGN KEY (`akun_id`) REFERENCES `Akun`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
