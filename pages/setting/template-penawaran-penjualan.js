...
export default function templatepenawaranpenjualan() {
    return (
        <Layout>
            <h1>Pengaturan</h1>
            <Row>
                ...
                <Col sm="8">
                    <h2>Template Email Penawaran Penjualan</h2>
                    <Row className="mb-2">
                        <Col sm="2">
                            <br/>
                        Subject
                    ...
                    <Row className="mb-2">
                        ...
                        <div className="card">
                            <div className="card-body">
                            Yth. [NamaCustomer], <br/>
                            Terima kasih atas permintaan penawaran Anda. <br/><br/>
                            Berikut adalah penawaran #[NomorTransaksi] sebesar [SisaTagihan]. <br/> <br/>
                    ...
                    <Row className="mb-2">
                        ...
                        <Col sm="10">
                        [NamaCustomer] [PerusahaanCustomer] [NomorTransaksi] [TanggalTransaksi] [TanggalExpiry] [NamaPerusahaan] [EmailPerusahaan] 
