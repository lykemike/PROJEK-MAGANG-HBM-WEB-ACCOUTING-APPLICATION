...
export default function templatepemesananpenjualan() {
    return (
        <Layout>
            <h1>Pengaturan</h1>
            <Row>
                ...
                <Col sm="8">
                    <h2>Template Pemesanan Penjualan</h2>
                    <Row className="mb-2">
                        <Col sm="2">
                            <br/>
                        Subject
                    ...
                    <Row className="mb-2">
                        ...
                        <div className="card">
                            ...
                            Berikut adalah pemesanan penjualan #[NomorTransaksi] sebesar [SisaTagihan]. <br/> <br/>
