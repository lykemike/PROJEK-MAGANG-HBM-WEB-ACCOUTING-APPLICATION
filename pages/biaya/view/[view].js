  ...
  return (
    <Layout>
      ...
      <div className="border-b border-gray-200">
        ...
        <Row>
          <Col sm="8">
            <h2 className="text-blue-600">Expense #{view}</h2>
          </Col>
        </Row>
      </div>
        ...
        <Table size="small" aria-label="a dense table">
          ...
          <TableBody>
            {data[0].DetailBiaya.map((i, index) => (
              <TableRow key={index}>
                <TableCell style={{ minWidth: 500, width: 500 }}>{i.akun.kode_akun + " - " + i.akun.nama_akun}</TableCell>
      ...
      <div>
        <Row className="mt-32">
          <Col sm="4" />
          <Col sm="4">
            <Link href={`../view/cetak/${data[0].id}`}>
              <a>
