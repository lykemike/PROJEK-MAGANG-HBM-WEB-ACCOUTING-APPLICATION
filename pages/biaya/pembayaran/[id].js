          ...
          <Forms noValidate>
			<div>
                ...
                <Col sm="3">
						...
						<Form.Control type="text" name="penerima" placeholder={i.kontak.nama} disabled >
						</Form.Control>
					</Col>
				))}
                    <Col sm="3">
					...
					<Col className="d-flex justify-content-end mr-3">
						<Row>
							...
							<h4 name='total' className="text-blue" >Rp. {parseInt(props.values.jumlah).toLocaleString({ minimumFractionDigits: 0 })}</h4>
						</Row>
					</Col>
				</Row>
			...
			{data.map((i) => (
				<Row>
					...
					<Col sm="3">
						...
						<Form.Control type="text" name="cara_pembayaran" value={i.cara_pembayaran} disabled placeholder={i.cara_pembayaran} disabled >
						</Form.Control>
					</Col>
					...
					<Col sm="3">
						<Form.Label className="font-medium">Tgl Pembayaran</Form.Label>
						    <Form.Control type="text" name="tgl_pembayaran" value={i.tgl_transaksi} disabled placeholder={i.tgl_transaksi}>
						    </Form.Control>
					</Col>

                    <Col sm="3">
						<Form.Label className="font-medium">Tgl Jatuh Tempo</Form.Label>
						    <Form.Control type="date" name="tgl_jatuh_tempo" onChange={props.handleChange}>
						    </Form.Control>
					</Col>

                    <Col sm="3">
						<Form.Label className="font-medium">No Transaksi</Form.Label>
						<Form.Control type="text" name="no_transaksi" placeholder={i.no_transaksi} disabled >
						</Form.Control>
					</Col>
				</Row>
			))}	
			...
			{data.map((i) => (
				...
				<Row className="mt-32">
					<Col className="d-flex justify-content-end">
						...
						<Button variant="success" onClick={props.handleSubmit}>Bayar</Button>
					</Col>
				</Row>
			</div>
			</Forms>
