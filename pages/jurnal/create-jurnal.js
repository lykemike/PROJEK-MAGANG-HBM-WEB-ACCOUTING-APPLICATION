                              ...
                              <Form.Group as={Row} controlId="formPlaintext">
                                ...
                                <Col sm="2">
                                  <Form.Control
                                    ...
                                    placeholder="Rp. 0,00"
                                    disabled={
                                      props.values.detail_jurnal[index]
                                        .debit_disable
                                    }
                                    ...
                                    onChange={(e) => {
                                      if (e.target.value.length > 0) {
                                        props.setFieldValue(
                                          `detail_jurnal.${index}.kredit_disable`,
                                          true
                                        );
                                        props.setFieldValue(
                                ...
                                <Col sm="2">
                                  <Form.Control
                                    ...
                                    onChange={(e) => {
                                      if (e.target.value.length > 0) {
                                        props.setFieldValue(
                                          `detail_jurnal.${index}.debit_disable`,
                                          true
                                        );
                                        props.setFieldValue(
                                          `detail_jurnal.${index}.kredit`,
