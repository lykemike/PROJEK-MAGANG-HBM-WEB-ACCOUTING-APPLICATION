              ...
              <div class='p-10 xs:p-0 mx-auto md:w-full md:max-w-md'>
                ...
                <div class='bg-white shadow w-full rounded-lg divide-y divide-gray-200'>
                  <div class='px-5 py-7'>
                    ...
                    <input type='text' class='border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full' name='loginEmail' onChange={props.handleChange} onBLur={props.handleBlur} />

                    <label class='font-semibold text-sm text-gray-600 pb-1 block'>Password</label>
                    <input type='text' class='border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full' name='loginPassword' onChange={props.handleChange} onBLur={props.handleBlur} />
                    <button
                      type='button'
