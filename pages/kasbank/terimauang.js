...
export default function terima_uang({ data, data2, data3, data4 }) {
    ...
    <Layout>
      <Formik
        initialValues={{
          ...
          hasil_pajak: 0,
          boolean: false,
          detail_terima_uang: [empty_detail_kirim_uang],
        }}
          ...
          <Forms noValidate>
            ...
            <div className="border-b border-gray-200">
              <Breadcrumbs aria-label="breadcrumb">
                ...
                <Typography color="textPrimary">Buat Terima Uang</Typography>
              </Breadcrumbs>
              ...
              <FieldArray name="detail_terima_uang">
                {({ insert, remove, push }) => (
                  <tbody style={{ height: "10rem" }}>
                          ...
                          <td style={{ minWidth: 250, width: 250 }}>
                            <Select
                              ...
                              onChange={(e) => {
                                ...
                                props.setFieldValue(`detail_terima_uang.${index}.pajak_jual_id`, result[0].akun_penjual);
                                ...
                                let pajak = props.values.detail_terima_uang[index].jumlah * (result[0].presentase_aktif / 100);
                            ...
                            <Form.Control
                              ...
                              onChange={(e) => {
                                if (e.target.value == "" || e.target.value == NaN) {
                                  ...
                                  props.setFieldValue((props.values.detail_terima_uang[index].jumlah = jumlah));
                                  props.setFieldValue(`detail_terima_uang.${index}.jumlah`, jumlah);
                                  ...
                                  props.setFieldValue((props.values.detail_terima_uang[index].hasil_pajak = pajak));
                                  props.setFieldValue(`detail_terima_uang.${index}.hasil_pajak`, pajak);
                                  ...
                                  let jumlah2 = props.values.detail_terima_uang[index].jumlah - pajak;
                                  props.setFieldValue((props.values.detail_terima_uang[index].jumlah2 = jumlah2));
                                  props.setFieldValue(`detail_terima_uang.${index}.jumlah2`, jumlah2);
                    ...
                    <Button className="ml-2 mt-4" onClick={() => push(empty_detail_kirim_uang)}>
