...
export default function BuatKontakBaru({ data, data2, data3 }) {
  ...
  const api_update_kontak = "http://localhost:3000/api/kontak/updatekontak";
  ...
  return (
    <Layout>
      ...
      <Formik
        ...
        innerRef={formik}
        initialValues={{
          namaPanggilan: data3.nama_panggilan,
          gelar: data3.gelar,
          nama: data3.nama,
          nomorHp: data3.nomor_hp,
          tipeIdentitas: data3.tipe_identitas,
          nomorIdentitas: data3.nomor_identitas,
          email: data3.email,
          infoLain: data3.info_lain,
          namaPerusahaan: data3.nama_perusahaan,
          nomorTelepon: data3.nomor_telepon,
          nomorFax: data3.nomor_fax,
          nomorNpwp: data3.nomor_npwp,
          alamatPembayaran: data3.alamat_pembayaran,
          alamatPengiriman: data3.alamat_pengiriman,
          namaBank: data3.nama_bank,
          kantorCabangBank: data3.kantor_cabang_bank,
          pemegangAkunBank: data3.pemegang_akun_bank,
          nomorRekening: data3.nomor_rekening,
          akunPiutang: "",
          akunHutang: "",
        ...
        onSubmit={async (values) => {
          let data = { ...values, id };
          Axios.put(api_update_kontak, data)
                ...
                <Card.Body>
                  <Form>
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.namaPanggilan}
                          type="text"
                          name="namaPanggilan"
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.nomorHp}
                          type="text"
                          name="nomorHp"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                        ...
                        <Row>
                          <Col sm="2">
                            <Form.Control
                              ...
                              onChange={props.handleChange}
                              onBlur={props.handleBlur}
                              value={props.values.tipeIdentitas}
                            >
                              <option disabled>Pilih</option>
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.infoLain}
                          type="text"
                          name="infoLain"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.namaPerusahaan}
                          type="text"
                          name="namaPerusahaan"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.nomorTelepon}
                          type="text"
                          name="nomorTelepon"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.nomorFax}
                          type="text"
                          name="nomorFax"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.nomorNpwp}
                          type="text"
                          name="nomorNpwp"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.alamatPembayaran}
                          type="text"
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.alamatPengiriman}
                          type="text"
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.namaBank}
                          type="text"
                          name="namaBank"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.kantorCabangBank}
                          type="text"
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.pemegangAkunBank}
                          type="text"
                    ...
                    <Row className="mb-2">
                      ...
                      <Col sm="10">
                        <Form.Control
                          placeholder={props.values.nomorRekening}
                          type="text"
                          name="nomorRekening"
                          onChange={props.handleChange}
                          onBlur={props.handleBlur}
...
export async function getServerSideProps(context) {
  ...
  const get_kontak = await prisma.kontak.findFirst({
    where: {
      id: parseInt(id),
    },
    include: {
