      ...
      <div className="fixed flex flex-col top-0 left-0 w-64 bg-dark h-full ">
        ...
        <div className="overflow-y-auto overflow-x-hidden flex-grow scrollbar-hide">
          ...
          <ul className="flex flex-col py-1 space-y-1">
            <li className="px-7">
              <div className="flex flex-row items-center h-8">
                <div className="text-lg font-light tracking-wide text-white">Transaction</div>
              </div>
            </li>
            {previlleges.length > 0
              ? previlleges.map((j) => {
          ...
          <ul className="flex flex-col py-1 space-y-1">
            <li className="px-7">
              <div className="flex flex-row items-center h-8">
                <div className="text-lg font-light tracking-wide text-white">Master Data</div>
              </div>
            </li>
            {previlleges.length > 0
              ? previlleges.map((j) => {
          ...
          <ul className="flex flex-col py-1 space-y-1">
            <li className="px-7">
              <div className="flex flex-row items-center h-8">
                <div className="text-lg font-light tracking-wide text-white">User & Role</div>
              </div>
            </li>
            {previlleges.length > 0
              ? previlleges.map((j) => {
