...
export default function TableDetailBBRow({ data, label = "Aset Lainnya" }) {
      ...
      <tr class="ml-4">
        <td colSpan="3" class={open ? "block" : "hidden"}>
          <table class="w-full">
            ...
            {data.map((asetLainnya) => (
              <tbody>
                <td colSpan="3" class="px-1 py-1">
                  <p>
                    {asetLainnya.kode_akun} - {asetLainnya.nama_akun}
                  </p>
                </td>
                ...
                <td colSpan="1" class="px-2 py-1">
                  <span class="text-black-300">
                    ...
                    {summary(
                      saldoakhir(
                        asetLainnya.DetailSaldoAwal[0].debit,
                        asetLainnya.DetailSaldoAwal[0].kredit,
                        penyesuaian(
                          "Debit",
                          asetLainnya.DetailJurnal,
                          asetLainnya.JurnalBiaya,
                          asetLainnya.JurnalKirimUang,
                          asetLainnya.JurnalTerimaUang,
                          asetLainnya.JurnalPenjualan,
                          asetLainnya.JurnalPembelian,
                          asetLainnya.JurnalTransferUang
                        ),
                        penyesuaian(
                          "Kredit",
                          asetLainnya.DetailJurnal,
