      ...
      <tr class="ml-4">
        <td colSpan="3" class={open ? "block" : "hidden"}>
          <table class="w-full">
            ...
            {data.map((liabilitasjkpendek) => (
              <tbody>
                <td colSpan="3" class="px-1 py-1">
                  <p>
                    {liabilitasjkpendek.kode_akun} -{" "}
                    {liabilitasjkpendek.nama_akun}
                  </p>
                </td>
                ...
                <td colSpan="1" class="px-2 py-1">
                  <span class="text-black-300">
                    ...
                    {summary(
                      saldoakhir(
                        liabilitasjkpendek.DetailSaldoAwal[0].debit,
                        liabilitasjkpendek.DetailSaldoAwal[0].kredit,
                        penyesuaian(
                          "Debit",
                          liabilitasjkpendek.DetailJurnal,
                          liabilitasjkpendek.JurnalBiaya,
                          liabilitasjkpendek.JurnalKirimUang,
                          liabilitasjkpendek.JurnalTerimaUang,
                          liabilitasjkpendek.JurnalPenjualan,
                          liabilitasjkpendek.JurnalPembelian,
                          liabilitasjkpendek.JurnalTransferUang
                        ),
                        penyesuaian(
                          "Kredit",
                          liabilitasjkpendek.DetailJurnal,
