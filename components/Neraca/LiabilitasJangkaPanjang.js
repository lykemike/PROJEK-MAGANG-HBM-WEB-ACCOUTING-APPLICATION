...
export default function TableDetailBBRow({
  data,
      ...
      <tr class="ml-4">
        <td colSpan="3" class={open ? "block" : "hidden"}>
          <table class="w-full">
            ...
            {data.map((liabilitasjkpanjang) => (
              <tbody>
                <td colSpan="3" class="px-1 py-1">
                  <p>
                    {liabilitasjkpanjang.kode_akun} -{" "}
                    {liabilitasjkpanjang.nama_akun}
                  </p>
                </td>
                ...
                <td colSpan="1" class="px-2 py-1">
                  <span class="text-black-300">
                    ...
                    {summary(
                      saldoakhir(
                        liabilitasjkpanjang.DetailSaldoAwal[0].debit,
                        liabilitasjkpanjang.DetailSaldoAwal[0].kredit,
                        penyesuaian(
                          "Debit",
                          liabilitasjkpanjang.DetailJurnal,
                          liabilitasjkpanjang.JurnalBiaya,
                          liabilitasjkpanjang.JurnalKirimUang,
                          liabilitasjkpanjang.JurnalTerimaUang,
                          liabilitasjkpanjang.JurnalPenjualan,
                          liabilitasjkpanjang.JurnalPembelian,
                          liabilitasjkpanjang.JurnalTransferUang
                        ),
                        penyesuaian(
                          "Kredit",
                          liabilitasjkpanjang.DetailJurnal,
