              ...
              <tbody>
                ...
                <td colSpan="1" class="px-2 py-1">
                  <span class="text-black-300">
                    ...
                    {summary(
                      saldoakhir(
                        asetTetap.DetailSaldoAwal[0].debit,
                        asetTetap.DetailSaldoAwal[0].kredit,
                        penyesuaian(
                          "Debit",
                          asetTetap.DetailJurnal,
                          asetTetap.JurnalBiaya,
                          asetTetap.JurnalKirimUang,
                          asetTetap.JurnalTerimaUang,
                          asetTetap.JurnalPenjualan,
                          asetTetap.JurnalPembelian,
                          asetTetap.JurnalTransferUang
                        ),
                        penyesuaian(
                          "Kredit",
                          asetTetap.DetailJurnal,
